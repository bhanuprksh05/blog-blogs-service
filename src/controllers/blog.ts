...
import { UserRequest } from "../middlewares/isAuth.js";
...
export const addComment = TryCatch(async (req: UserRequest, res) => {
...
export const saveBlog = TryCatch(async (req: UserRequest, res) => {
...
export const getSavedBlog = TryCatch(async (req: UserRequest, res) => {
  const blogs =
